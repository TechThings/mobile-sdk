...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExperianMobileSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ExperianMobileSDK11EXMobileSDK")
@interface EXMobileSDK : NSObject
/// Get SDK Version
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger sdkVersion;)
+ (NSInteger)sdkVersion SWIFT_WARN_UNUSED_RESULT;
...
/// Start framework
/// \param application A reference of UIApplication instance
///
+ (void)runWithApplication:(UIApplication * _Nonnull)application;
/// Execute SDK collectors and send data if conditions are reached
+ (void)execute;
/// Execute SDK collectors and send data if conditions are reached
+ (void)backgroundFecthWithCompletion:(void (^ _Nullable)(UIBackgroundFetchResult))completion;
/// Force to execute SDK collectors and send data ignoring conditions
+ (void)executeInstant;
@end


/// Provide custom data to SDK
SWIFT_CLASS("_TtC17ExperianMobileSDK12EXSharedData")
@interface EXSharedData : NSObject
/// Get current EXSharedData reference
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) EXSharedData * _Nonnull sharedInstance;)
+ (EXSharedData * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// Get current EXSharedData stored values
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull sharedValues;
/// Get or store a CPF. This field doesn’t check if is value is valid
@property (nonatomic, copy) NSString * _Nonnull partnerCode;
/// Get or store a CNPJ. This field doesn’t check if is value is valid
...
- (void)setCustomFieldWithKey:(NSString * _Nullable)key value:(NSString * _Nullable)value hashed:(BOOL)hashed;
/// Retrieve a stored value
- (NSString * _Nonnull)getCustomFieldWithKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
